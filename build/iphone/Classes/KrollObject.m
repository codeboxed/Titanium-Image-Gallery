...
//@interface TitaniumImageGalleryObject : NSObject
//@end

@interface TitaniumImageGalleryObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TitaniumImageGalleryObject class]])
		{
			for (NSString *key in [[(TitaniumImageGalleryObject*)o modules] allKeys])
			{
