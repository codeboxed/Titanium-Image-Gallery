...
// in simulator we redefine to format for TitaniumImageGallery Developer console
...
{\
	NSString * exceptionName = [@"org.titaniumimagegallery." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.titaniumimagegallery";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UITitaniumImageGalleryNativeItemNone = -1, 
	UITitaniumImageGalleryNativeItemSpinner = -2,
	UITitaniumImageGalleryNativeItemProgressBar = -3,
	
	UITitaniumImageGalleryNativeItemSlider = -4,
	UITitaniumImageGalleryNativeItemSwitch = -5,
	UITitaniumImageGalleryNativeItemMultiButton = -6,
	UITitaniumImageGalleryNativeItemSegmented = -7,
	
	UITitaniumImageGalleryNativeItemTextView = -8,
	UITitaniumImageGalleryNativeItemTextField = -9,
	UITitaniumImageGalleryNativeItemSearchBar = -10,
	
	UITitaniumImageGalleryNativeItemPicker = -11,
	UITitaniumImageGalleryNativeItemDatePicker = -12,
	
	UITitaniumImageGalleryNativeItemInfoLight = -13,
	UITitaniumImageGalleryNativeItemInfoDark = -14,
	
	UITitaniumImageGalleryNativeItemDisclosure = -15,
	
	UITitaniumImageGalleryNativeItemContactAdd = -16
};
